...
- `squads/` e `bases/` — Knowledge Bases pessoais do usuário (gitignored, ficam locais)
  ...
  - `squads/{squad}/clientes/{cliente}/` — cada cliente tem `calls/` (transcripts brutos), `checkins/` (pautas, ensaios e reviews), `docs/`, `campanhas/`, `mission-control/` (estado vivo), `links.md` (recursos recorrentes — NotebookLM, Drive, site, etc) e `CLAUDE.md`/`AGENTS.md` próprios.
...
- [[novo-cliente]] · [[novo-projeto]] — Cria pasta de KB com estrutura padrão. [[novo-cliente]] agora pede o squad e coleta links úteis (NotebookLM, Drive, site, outros) que ficam em `links.md`.
...
- Context root: `/home/marcos/Desktop/v4perettoco-main-final/v4perettoco-main`
