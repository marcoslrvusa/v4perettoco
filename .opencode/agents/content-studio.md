...
- @copy-orchestrator — full copy pipeline (briefing → research → strategy → writing → editing → review)
...
4. **Create**: Commission @copy-orchestrator for writing, @criacao-design for visuals
...
|--------|---------|--------|-------------|-----------|
| W01    | Blog post | ... | @copy-orchestrator | 85/100 |
| W02    | LinkedIn thread | ... | @copy-orchestrator | - |
| W03    | Lead magnet | ... | @copy-orchestrator + @criacao-design | 90/100 |
