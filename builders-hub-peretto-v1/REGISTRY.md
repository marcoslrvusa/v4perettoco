...
**12 skills** · última atualização: 2026-04-30
...
| Skill | O que faz | Autor | v |
|---|---|---|---|
| `gestao-novo-cliente-peretto` | Cria um novo cliente seguindo o padrão da unidade Peretto & Co. Use quando o usuário quiser adicionar um cl... | @marcoslrvusa | 1.0.0 |
