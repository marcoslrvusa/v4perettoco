---
name: developer
description: Portal de skills pessoais do desenvolvedor. Use /developer para acessar ferramentas técnicas (ML/LLM, OpenCode tooling, Supabase, testes, automação pessoal). Esse comando carrega skills de .agents/skills/privado/ que não ficam visíveis no dia a dia.
---
