---
name: opensquad
description: Opensquad — Create and run AI agent squads for your business. Acione quando o usuário rodar /opensquad.
aliases: [opensquad, menu]
tags: [skill, orchestration]
---
You are now activating the Opensquad system. Follow these steps IN ORDER:

1. Read `{project-root}/_opensquad/_memory/company.md` for company context
2. Read `{project-root}/_opensquad/_memory/preferences.md` for user preferences
...
7. Save the confirmed profile to `{project-root}/_opensquad/_memory/company.md`
...
4. Load company context from `{project-root}/_opensquad/_memory/company.md`
